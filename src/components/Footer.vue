<template>
    <div class="footBack">
        <div class="fcontainer">
            <p>
                Eudora的个人博客已悄咪咪运行<span v-html='longTime'>{{longTime}}</span><span class="timeJump">(●'◡'●)ﾉ♥</span>
            </p>
            <p>
                托管于 <a href="https://github.com/Eudorai/blog" target="_blank">GitHub</a>
            </p>
            <p>
                © 2020 <a href="#">Mango Ya</a>. 由 <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动.
                京ICP备17071595号-1.
            </p>
            <p>
                <span>Made with</span> <img class="fheart" src="../assets/img/heart02.png" alt=""/>
                <span>by Eudora.</span>
            </p>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            runTime: function () {//运行倒计时
                let that = this;
                let oldTime = new Date('2020/03/15 00:00:00');
